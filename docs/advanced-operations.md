...
//   Kleisli(cats.data.Kleisli$$Lambda$1495/629023483@2d5d001f)
// ) // 
...
//   Kleisli(cats.data.Kleisli$$Lambda$1495/629023483@7a92827f)
...
//   Kleisli(doric.syntax.NonEmptyTypeMatcher$$Lambda$2970/397763798@43094e0c)
// )
```
...
//   Kleisli(doric.syntax.NonEmptyTypeMatcher$$Lambda$3006/444486796@16cbba0f)
// )
```
```scala
