...
[![Maven Central](https://img.shields.io/maven-central/v/org.hablapps/doric_3-4_2.12)](https://mvnrepository.com/artifact/org.hablapps/doric_3-4_2.12/0.0.6)

_Sbt_
```scala
libraryDependencies += "org.hablapps" % "doric_3-4_2.12" % "0.0.6"
```
_Maven_
```xml
<dependency>
...
* The latest experimental version of doric is 0.0.0+1-a803eed4-SNAPSHOT.
...
// 'Project [unresolvedalias((value#365 * true), Some(org.apache.spark.sql.Column$$Lambda$5076/0x0000000101ba6840@570569c4))]
...
//   'Project [unresolvedalias((cast(str#378 as double) + true), Some(org.apache.spark.sql.Column$$Lambda$5076/0x0000000101ba6840@570569c4))]
