...
/*
  ...
  // Tests from ArrayColumns3xSpec (Spark 3.x+ features not yet working in Spark 4.0)
  // These tests are commented out and will be uncommented once the functionality is implemented
  ...
  describe("sort doric function (with custom comparator)") {
